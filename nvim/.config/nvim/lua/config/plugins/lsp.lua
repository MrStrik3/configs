...
return
{
  ...
  { "williamboman/mason.nvim", lazy = false, cmd = "Mason", opts = true },
...

  {
      ...
      lspzero.on_attach(
        function(client, bufnr)
          if vim.b.lsp_attached then
            -- if vim.lsp.is_attached(bufnr, client) then
            return
          end
    ...
    dependencies = { "williamboman/mason.nvim", "VonHeikemen/lsp-zero.nvim", "smiteshp/nvim-navic" }
  },
  ...
  { "folke/neodev.nvim",       lazy = false,      opts = true },
  { "smjonas/inc-rename.nvim", cmd = "IncRename", config = true }, -- Renaming a variable plugin
