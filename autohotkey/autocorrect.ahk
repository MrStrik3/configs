...
; StrReplace( Hotstring, Clipboard, ``, ````, All)  ; Do this replacement first to avoid interfering with the others below.
; StrReplace( Hotstring, Hotstring, `r`n, ``r, All)  ; Using `r works better than `n in MS Word, etc.
